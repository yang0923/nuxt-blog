		...
		<section class="relative py-12 md:py-20 overflow-hidden">
			<div class="relative z-10 text-center space-y-6">
				...
				<div class="flex items-center justify-center gap-4 pt-4">
					<NuxtLink to="/archive" class="px-8 py-3 rounded-xl bg-primary-500 text-white font-bold shadow-lg shadow-primary-500/25 hover:scale-105 transition-transform"> 开始阅读 </NuxtLink>
					<a
		...
		<section class="space-y-8">
			...
			<div class="grid gap-6 md:grid-cols-3">
				<NuxtLink
					...
					:key="post.path"
					:to="post.path"
					class="group relative bg-brand-card border border-primary-500/5 rounded-2xl p-6 hover:border-primary-500/20 transition-all shadow-sm"
				>
					<div class="space-y-4">
